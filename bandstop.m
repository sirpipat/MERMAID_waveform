function [xf,co,npol,npas,tipe,HABS2,F,EPB]=...
    bandstop(x,Fs,colo,cohi,npol,npas,tipe,trending)
% [xf,co,npol,npas,tipe,HABS2,F,EPB]=BANDSTOP(x,Fs,colo,cohi,npol,npas,tipe,trending)
%
...
disp(sprintf('BANDSTOP %3.3f-%3.3f Hz %i pass %i poles %s',...
